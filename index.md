...
> Программирование на Python, умение писать ясный структурированный код
> • Знание основ ООП
> • Знание алгоритмов. (мои работы:
> • Мой github https://github.com/konicaRu
> • Проведение unit тестирование кода
> • Знание SQL, опыт работы с MySQL и оптимизации запросов
> • Знание систем автоматического тестирования (unit)
> • Понимание принципов сервисной архитектуры
> • Опыт работы с git.
> • Опыт использования командной строки.
> • Знаком с принципами работы NumPy
> • Знаком с принципами работы Pandas
> • Мой блог по программированию и не только: https://konicaru.github.io/
>

...
<html>
  ...
  <head>
    ...
    <title>Резюме Кочетов Дмитрий</title>
  </head>

  <body>
    <div id="header">
      <h1>Кочетов Дмитрий</h1>
    ...
    <div id="footer">
      <strong>Кочетов Дмитрий</strong>
      <br/>
      ул. Полевая, 12, Череповец, Россия +7 888 127 00 01, <a href="mailto:ap@somemail.com">ap@somemail.com</a>
    </div>
